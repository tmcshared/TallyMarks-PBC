...
ProductionEntriesPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: "page-production-entries",template:/*ion-inline-start:"/Users/tmc/Documents/Punjab Bevearage/src/pages/production-entries/production-entries.html"*/'<ion-header>\n\n  <ion-navbar>\n    <ion-title>Today\'s Production Entries</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n  <ion-card style="border-radius: 0;">\n    <ion-card-content>\n      <ion-grid>\n\n\n        <ion-item-divider color="light">\n          <ion-row>\n\n            <ion-col col-2>\n              Line Name\n            </ion-col>\n            <ion-col col-2>\n              Entry Date\n            </ion-col>\n            <ion-col col-4>\n              Problem Name\n            </ion-col>\n            <ion-col col-2>\n              Shift\n            </ion-col>\n            <ion-col col-2>\n              Time Slot\n            </ion-col>\n          </ion-row>\n\n        </ion-item-divider>\n        <ion-item-divider  style="border-bottom:0;">\n            <ion-row *ngFor="let item of entriesList">\n                <ion-col col-2>\n                  <ion-item-divider class="cut-text">\n                      {{item.lineName}}\n                  </ion-item-divider>\n                 \n                </ion-col>\n                <ion-col col-2>\n                  <ion-item-divider class="cut-text">\n                      {{item.entryDate}}\n                  </ion-item-divider>\n                </ion-col>\n                <ion-col col-4>\n                  <ion-item-divider class="cut-text" style="width:250px">\n                      {{item.problemName}}\n\n                  </ion-item-divider>\n                </ion-col>\n                <ion-col col-2>\n                  <ion-item-divider class="cut-text">\n                      {{item.shift}}\n\n                  </ion-item-divider>\n                </ion-col>\n                <ion-col col-2>\n                  <ion-item-divider class="cut-text">\n                      {{item.timeSlot}}\n\n                  </ion-item-divider>\n                </ion-col>\n              </ion-row>\n          </ion-item-divider>\n       \n      </ion-grid>\n    </ion-card-content>\n\n  </ion-card>\n</ion-content>'/*ion-inline-end:"/Users/tmc/Documents/Punjab Bevearage/src/pages/production-entries/production-entries.html"*/
    }),
